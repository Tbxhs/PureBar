...
enum Localized {
  ...
  enum UI {
    ...
    static let menuTitlePastEvents = String(localized: "Past Events", comment: "[Menu] Section title for past events display style")
    static let menuTitlePastDimmedStrikethrough = String(localized: "Dimmed & Strike-through", comment: "[Menu] Display past events dimmed with a strike-through")
    ...
    static let menuTitleShowLunarDates = String(localized: "Show Lunar Dates", comment: "[Menu] Show lunar dates in the calendar grid")
