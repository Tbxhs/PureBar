...
enum Localized {
  ...
  enum UI {
    ...
    static let menuTitleMenuBarIconBasic = String(localized: "Basic Icons", comment: "[Menu] Section title for basic menu bar icons")
    static let menuTitleMenuBarIconCustom = String(localized: "Custom", comment: "[Menu] Section title for custom menu bar icons")
    ...
    static let menuTitleCompletedReminders = String(localized: "Completed Reminders", comment: "[Menu] Section title for completed reminders display style")
    static let menuTitleCompletedStrikethrough = String(localized: "Strike-through", comment: "[Menu] Display completed reminders with a strike-through")
    static let menuTitleCompletedDimmed = String(localized: "Dimmed", comment: "[Menu] Display completed reminders in a dimmed color")
    static let menuTitleCompletedHidden = String(localized: "Hidden", comment: "[Menu] Do not display completed reminders")
    ...
    static let menuTitleQuit = String(localized: "Quit PureBar", comment: "[Menu] Quit the app")
    ...
    static let alertExplanationSetDateFormat = String(localized: "Enter date format, e.g., `M/d HH:mm`, `yyyy-MM-dd`. More examples: [Help](https://github.com/Tbxhs/PureBar/wiki/CustomDateFormat)", comment: "[Alert] Explanation and examples for custom date format")
