...
/// It has a configurable <code>hitTestInsets</code> to make the hitTest rect larger.
SWIFT_CLASS("_TtC14AppKitControls12CustomButton")
...
/// A custom <code>NSTextField</code> subclass that enables common editing keyboard shortcuts
...
SWIFT_CLASS("_TtC14AppKitControls17EditableTextField")
...
SWIFT_CLASS("_TtC14AppKitControls11ImageButton")
@interface ImageButton : CustomButton
- (void)layout;
...
SWIFT_CLASS("_TtC14AppKitControls9TextLabel")
@interface TextLabel : NSTextField
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
@end
